...
int main() {
  ...
  xSemaphore_r = xSemaphoreCreateBinary(); // Cria o semaforo r
  xSemaphore_g = xSemaphoreCreateBinary(); // cria o semaforo g

  // Tasks para o botao e led vermelho
  xTaskCreate(led_1_task, "LED_Task 1", 256, NULL, 1, NULL);
  xTaskCreate(btn_1_task, "BTN_Task 1", 256, NULL, 1, NULL);

  // Tasks para o botao e led verdes
